...
public class BigInteger extends Number implements Comparable<BigInteger> {
    ...
    if (firstGroupLen == 0)
        ...
        magnitude[numWords - 1] = parseInt(val, cursor,  cursor +=
firstGroupLen);
     ...
     */
    private static BigInteger smallPrime(int bitLength, int certainty, Random
rnd) {
     ...
     * test.
     */
    private static BigInteger largePrime(int bitLength, int certainty, Random
rnd) {
        BigInteger p;
...
BigInteger n) {
    ...
    private static Random staticRandom = new java.security.SecureRandom();
    ...
    public BigInteger multiply(BigInteger val) {
        ...
        int[] res = multiplyToLen(mag, mag.length, val.mag, val.mag.length,
null);
